			...
			<div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
				<Card className="max-w-md w-full">
					<CardHeader>
						...
						<CardDescription>
							Access to Schools management requires a Paid Admin account.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<Link to="/upgrade">
				...
				<Card>
					<CardContent className="py-16 text-center">
						...
						<p className="text-gray-600 mb-6 max-w-md mx-auto">
							Get started by adding your first school. You'll be able to configure
							locations, add students, and track attendance.
						</p>
						<Button>
							<Plus className="size-5 mr-2" />
