...
export const Route = createFileRoute("/developer/organizations")({
	component: DeveloperOrganizationsPage,
});

function DeveloperOrganizationsPage() {
	const { user } = useAuth();
			...
			<div className="max-w-7xl mx-auto">
				...
				<Card className="bg-gray-800 border-gray-700">
					<CardContent className="py-16 text-center">
						<Building className="size-16 text-gray-600 mx-auto mb-4" />
						<h3 className="text-xl font-semibold text-white mb-2">
							Organizations Management
						</h3>
						<p className="text-gray-400 mb-6 max-w-md mx-auto">
							This interface will display all organizations with their schools,
